...
$(function()
{
	...
	$('#tuner').on('click', '.colors li', function()
	{
		...
		$('#foxin img').attr('src', 'public/images/' + $(this).data('color') + '/logo.png');
     	$('#fox_footer img').attr('src', 'public/images/' + $(this).data('color') + '/logofooter.png');
		$('head').append('<link rel="stylesheet" href="public/css/themes/color-' + $(this).data('color') + '.css">');
	});
